...
| `at ui 엑셀` | 일곱 탭 - 훑어보기(한 번에 훑기·점검·드문 값·빠진 것·합쳐 둔 칸 알림)·고치기(정리·표기 통일·빈 칸·날짜 열·마감일·나이·근무 시간과 임금·찾아 바꾸기)·골라내기(집계·그림)·여러 파일(서식 견주기·찾기·취합·메일 초안)·내보내기 전에(가리기·비슷한 값)·캘린더·연락처(ics·vcf)·인쇄(주소 라벨) |
