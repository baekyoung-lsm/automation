...
| `at ui 파일정리` | 정리·사진 촬영일별·중복 모으기·두 폴더 견주기 |
| `at ui 바꾸기` | 여러 파일의 글자·인코딩·줄바꿈을 한꺼번에 |
| `at ui 엑셀` | 열어 보기·점검·집계·골라내기·비교·합치기·표기 통일·정리 |
| `at ui 문서` | 마크다운 점검·용어 흔들림·그림 점검·목차·표 정렬·내보내기 |
...
| `at ui 개발` | JWT·시각·cron·가리기·인코딩·키·.env·로그 훑기·sqlite |
| `at ui json` | 응답 구조·두 응답 비교·표로·타입 코드 |
| `at ui 저장소` | 커밋 전 점검·시크릿·묵은 브랜치·충돌·TODO·커밋 통계 (읽기만) |
