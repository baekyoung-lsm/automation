...
| `at file docs [디렉터리]` | 워드·엑셀·슬라이드·PDF 속성 목록 - 제목·만든 사람·쪽 수. 문서에 남은 이름을 찾는다 |
...
`at file scrub` 은 그 이름들을 지운 **사본**을 만든다(`…(이름지움).docx`). 워드·엑셀·슬라이드만 다루고 PDF 는 건드리지 않는다. 원본은 건드리지
